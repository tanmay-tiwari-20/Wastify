...
export default function CollectPage() {
  ...
  //       toast.error('Error parsing AI response. Please try again.', { duration: 5000, position: 'top-center' })
  //     }
  //   } catch (error) {
  //     console.error('Error verifying waste:', error)
  //     setVerificationStatus('failure')
  //     toast.error('Error verifying waste. Please try again later.', { duration: 5000, position: 'top-center' })
  //   }
  // };
  const handleVerify = async () => {
    if (!selectedTask || !verificationImage || !user) {
